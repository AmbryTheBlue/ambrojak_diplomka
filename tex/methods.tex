...
Effective for continuous, normally distributed data. \cite[outlierSurvey]
...
Deep learning (DL) has rapidly enriched the anomaly-detection toolbox by replacing hand-crafted representations with features learned automatically from raw data, often yielding large accuracy gains on images, audio and high-dimensional sensor streams. Unlike classic statistical or tree-based methods that work directly in the original space, modern DL detectors embed inputs into a non-linear manifold where “normality” is easier to model and deviations stand out. \cite[deeplearninganomalydetection]
