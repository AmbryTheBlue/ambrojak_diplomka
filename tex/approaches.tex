...
This approach is closely related to the Maximum Softmax Probability (MSP) technique introduced by Hendrycks and Gimpel (2017)\cite[https://arxiv.org/abs/1610.02136], which was originally developed for detecting out-of-distribution inputs in image classification models. However, the general principle is directly applicable to categorical decision problems, including the transport order domain investigated in this thesis.
