...
This section provides more precise description of the steps involved in our machine learning pipeline. This includes detailing preprocessing, vectorization and synthetic anomaly generation. With some small illustrative code snippets, the key files are in full located in the Appendix \ref[src-snippets].\fnote{For more curious readers, the source code in full is located in \url{GitHub}}
\rfc{Addd Github Link}
