...
\title      {NLP in order verification}
\subtitle   {Sofware or Research project}
            % \subtitle is optional
\author     {Jakub Ambroz}
\date       {September 2024, January 2025}
\supervisor {Martin Komínek}  % One or more supervisors
\studyinfo  {Open informatics, specialization Data science}  % Study programme etc.
\workname   {Sofware or Research project} % Used only if \worktype [O/*] (Other)
